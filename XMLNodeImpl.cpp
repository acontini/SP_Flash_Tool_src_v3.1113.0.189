...
void NodeImpl::AppendText(const std::wstring &text)
{
    ...
    {
        XMLEXCEPTION("Failed to add newline");
    }
}
                                      ...
                                      unsigned int childIndex)
{
    ...
    {
        XMLEXCEPTION("Failed to prepend text");
    }
}
...
NodeImpl* NodeImpl::AppendChildNode(const std::wstring &name)
{
    ...
    {
        XMLEXCEPTION("Failed to append child node");
    }
...
std::wstring NodeImpl::GetAttribute(const std::wstring &name)
{
    ...
    {
        XMLEXCEPTION("Failed to get attribute of the node");
    }
...
TCOMIXMLDOMElement NodeImpl::GetElementInterface()
{
    ...
    {
        XMLEXCEPTION("IXMLDOMElement interface not supported");
    }
