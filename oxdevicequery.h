...
#define CTL_CODE_T(t,f,m,a) 			(((t)<<16)|((a)<<14)|((f)<<2)|(m))
#define FILE_DEVICE_SERIAL_PORT_T		27
#define METHOD_BUFFERED		 		0
#define FILE_READ_ACCESS_T		 	0x00000001
...
#define IOCTL_OXSER_QUERY_INFO \
    CTL_CODE_T( FILE_DEVICE_SERIAL_PORT_T, 63, METHOD_BUFFERED, FILE_READ_ACCESS_T)
...
#define IOCTL_OXSER_CF950_GPIO \
    CTL_CODE( FILE_DEVICE_SERIAL_PORT_T, 62, METHOD_BUFFERED, FILE_READ_ACCESS_T )
