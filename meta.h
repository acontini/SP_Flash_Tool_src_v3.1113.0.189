...
typedef struct {
    unsigned int    PaOctLevelControl:1;
    unsigned int    PaPhaseCompensationConversion:1;
    unsigned int    PaCouplerLossByPaMode:1;
    unsigned int    HsdpaNsft:1;
    unsigned int    HsupaNsft:1;
...
typedef union {
    ...
    UL1D_RF_FHC_EX_CNF_T          fhcExResult;
...
META_RESULT  __stdcall META_3Grf_QueryFHCExResult(unsigned int  ms_timeout, UL1D_RF_FHC_EX_CNF_T *cnf);
META_RESULT  __stdcall META_3Grf_QueryFHCExResult_r(const int meta_handle, unsigned int  ms_timeout, UL1D_RF_FHC_EX_CNF_T *cnf);
