...
LIBEXPORT int  __stdcall Boot_META(
        HANDLE hCOM,
...
int __stdcall BootROM_BootMode(BOOT_ARG_S * pArg);
...
LIBEXPORT int __stdcall Brom_Create(BROM_HANDLE_T *p_brom_handle, HANDLE hCOM, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, BOOT_RESULT *p_result);
...
//class BRom_Base;
LIBEXPORT int __stdcall Brom_WriteEfuseCommon(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Common_Arg *common_arg, bool error_log_en);
LIBEXPORT int __stdcall Brom_WriteEfuseSecure(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Secure_Arg *secure_arg, bool error_log_en);
LIBEXPORT int __stdcall Brom_WriteEfuseLock(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, const Efuse_Lock_Arg *lock_arg, bool error_log_en);
LIBEXPORT int __stdcall Brom_ReadEfuseAll(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle, Efuse_Common_Arg *common_arg, Efuse_Secure_Arg *secure_arg, Efuse_Lock_Arg *lock_arg, bool error_log_en);
LIBEXPORT int __stdcall Test_WriteEfuse(unsigned int brom_handle, FLASHTOOL_API_HANDLE_T ft_handle);
