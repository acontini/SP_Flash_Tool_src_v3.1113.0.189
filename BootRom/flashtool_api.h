...
#define ENABLE_64BIT_PROTOCOL
#define LOWER_8BIT 0x00000000000000FF
#define LOWER_32BIT 0x00000000FFFFFFFF

//#define ENABLE_NOR_SUPPORT
...
typedef struct DA_REPORT_T {
    ...
    unsigned short      m_nand_flash_dev_code_5;
    ...
    // EMMC flash report
    STATUS_E            m_emmc_ret;
    unsigned int        m_emmc_boot1_size;
    unsigned int        m_emmc_boot2_size;
    unsigned int        m_emmc_rpmb_size;
    unsigned int        m_emmc_gp1_size;
    unsigned int        m_emmc_gp2_size;
    unsigned int        m_emmc_gp3_size;
    unsigned int        m_emmc_gp4_size;
    U64                 m_emmc_ua_size;
    U32                 m_emmc_cid[4];
    U8                   m_emmc_fwver[8];
...
typedef int (__stdcall *CALLBACK_CHECKSUM_PROGRESS)(unsigned char finished_percentage, unsigned int finished_bytes, unsigned int total_bytes, void *usr_arg);
typedef int (__stdcall *CALLBACK_READBACK_PROGRESS_INIT)(HW_StorageType_E  storage_type, U64 rb_addr, unsigned int rb_length, const char *rb_filepath, void *usr_arg);
...
LIBEXPORT int __stdcall FlashTool_NandUtil_Connect(
...
//------------------------------------------------------------------------------
LIBEXPORT int __stdcall FlashTool_WriteUSBDownloadControlBit(FLASHTOOL_API_HANDLE_T ft_handle);
...
LIBEXPORT int __stdcall FlashTool_GetFATRanges(FLASHTOOL_API_HANDLE_T ft_handle,
                                            Range *nor_fat_range,
...
LIBEXPORT int __stdcall FlashTool_SecRO_GetInfo(FLASHTOOL_API_HANDLE_T  ft_handle, SecRO_Info_T  *p_sec_ro_info);
LIBEXPORT int __stdcall FlashTool_SecRO_Read(FLASHTOOL_API_HANDLE_T  ft_handle, SecRO_T  *p_sec_ro);
LIBEXPORT int __stdcall FlashTool_SecRO_Write(FLASHTOOL_API_HANDLE_T  ft_handle, const SecRO_T  *p_sec_ro);
...
LIBEXPORT int __stdcall FlashTool_CustPara_GetInfo(FLASHTOOL_API_HANDLE_T  ft_handle, CustPara_Info_T  *p_cust_para_info);
LIBEXPORT int __stdcall FlashTool_CustPara_Read(FLASHTOOL_API_HANDLE_T  ft_handle, CustPara_T  *p_cust_para);
LIBEXPORT int __stdcall FlashTool_CustPara_Write(FLASHTOOL_API_HANDLE_T  ft_handle, const CustPara_T  *p_cust_para);
...
//------------------------------------------------------------------------------
LIBEXPORT int __stdcall RepairTool_GetDIRInfo( FLASHTOOL_API_HANDLE_T  ft_handle, char * fn_dir);
LIBEXPORT int __stdcall RepairTool_GetExceptionRecord( FLASHTOOL_API_HANDLE_T  ft_handle, char * fn_exceptionlog, char * fn_store);
...
LIBEXPORT int __stdcall FlashTool_ExtractNFB( FLASHTOOL_API_HANDLE_T  ft_handle, char * fn_store, const FlashTool_Progress_Arg  *p_pgs_arg);
LIBEXPORT int __stdcall FlashTool_InjectNFB( FLASHTOOL_API_HANDLE_T  ft_handle, char * fn_store, const FlashTool_Progress_Arg  *p_pgs_arg);
...
LIBEXPORT int __stdcall FlashTool_RelayDA( FLASHTOOL_API_HANDLE_T  ft_handle, const GPIO_GPS_SETTING *p_gpio_gps);

LIBEXPORT int __stdcall FlashTool_ReadPartitionCount(FLASHTOOL_API_HANDLE_T ft_handle, unsigned int *p_part_count);
LIBEXPORT int __stdcall FlashTool_ReadPartitionInfo(FLASHTOOL_API_HANDLE_T ft_handle, PART_INFO *p_part_info, unsigned int max_part_count);
